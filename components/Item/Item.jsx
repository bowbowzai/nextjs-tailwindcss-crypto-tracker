  ...
  return (
    <Link href={`/coin/${id}`}>
      <a href="" className="text-white">
        <div className="grid grid-cols-3 lg:grid-cols-6 grid-rows-1 gap-x-1 lg:gap-x-10 border-b-1 border-gray-400 items-center text-center lg:text-left text-white py-3 px-2 hover:bg-gray-800">
